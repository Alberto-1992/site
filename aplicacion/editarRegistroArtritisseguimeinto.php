...
date_default_timezone_set("America/Monterrey");
    ...
    $hora = date("Y-m-d h:i:sa");
        ...
        $sql = $conexionCancer->prepare("UPDATE seguimientoartritis set editopacienteseguimiento = :editopacienteseguimiento where id_seguimientoartritis = :id_seguimientoartritis");
            $sql->bindParam(':id_seguimientoartritis',$id, PDO::PARAM_INT);
            $sql->bindParam(':editopacienteseguimiento',$valor, PDO::PARAM_INT);
            $sql->execute();
